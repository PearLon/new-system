    					 ...
    					 <div class="clear"></div>
		                    ...
		                    <font color="red" size="5">
								...
								<tr>
									...
									<td><font color="white" size="5">编号</td>
									<td><font color="white" size="5">型号</td>
									<td><font color="white" size="5">生产</td>
									<td><font color="white" size="5">类型</td>
								...
								<c:forEach items="${requestScope.list}" var="p">
									...
									<td><font color="white" size="5">${p.id}</td>
									<td><font color="white" size="5">${p.model}</td>
									<td><font color="white" size="5">${p.builder}</td>
									<td><font color="white" size="5">${p.type}</td>
									<td><font color="white" size="5">${p.wood}</td>
